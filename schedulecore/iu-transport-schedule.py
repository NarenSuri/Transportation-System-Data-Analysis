...
def bus_analysis(data_gen):
    ...
    while True:
        try:           
            ...
            print('ONE batch OVER!!! with start at {},{}' .format(day_first_record[3],day_first_record[5]))
            print('ONE batch OVER!!! with end at {},{}' .format(last_record_day_trips[3],last_record_day_trips[5]))                
